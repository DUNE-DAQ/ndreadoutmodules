...
local cs = {
    ...
    ndreadoutmodules: s.record("ndreadoutmodules", [
        s.field( "some_configured_value", self.int4, default=31415, doc="A value which configures the DummyModule DAQModule instance"),
        s.field( "num_dummymodules", self.int4, default=1, doc="A value which configures the number of instances of DummyModule"),
    ]),

    ndreadoutmodules_gen: s.record("ndreadoutmodules_gen", [
        s.field("boot", daqconf.boot, default=daqconf.boot, doc="Boot parameters"),
        s.field("ndreadoutmodules", self.ndreadoutmodules, default=self.ndreadoutmodules, doc="ndreadoutmodules parameters"),
    ]),
};
